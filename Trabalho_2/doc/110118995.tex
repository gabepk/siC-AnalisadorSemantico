...
\begin{itemize}
	...
	\item Agora, além da variável "argument", também existe a variável "arguments", que permite a definição de um ou mais argumentos em uma função.
	A assinatura da função
\end{itemize}

Segue abaixo a gramática proposta, em que a variável inicial é \textit{function}.
...
statement
   \(\to\) argument ';'
    ...
    | identifier = {\color{red}number\_expression} ;
