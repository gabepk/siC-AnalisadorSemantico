...
\begin{center}
 ...
 \hline
 4 & {digito}+"."{digito}* & Identifica números float\\
 \hline
 5 & {digito}+ & Identifica números inteiros\\
 \hline
 6 & "'"(\{letra\}|\{digito\})"'" & Identifica valor para uma variável do \\&& tipo char, que pode ser uma letra ou dígito\\
 \hline
 7 & \{comparison\} & Identifica símbolos de comparação \\&& entre dois elementos \\
 \hline
 8 & \{mark\} & Identifica pontuação e delimitadores de \\&& blocos e valores de char\\
 \hline
 9 & \{operator\} & Identifica operadores matemáticos \\
 \hline
 10 & (?i:"VOID")& Identifica palavra chave tipo void \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 11 & (?i:"FLOAT")& Identifica palavra chave tipo float \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 12 & (?i:"INT")& Identifica palavra chave tipo inteiro \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 13 & (?i:"CHAR") & Identifica palavra chave tipo char \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 14 & (?i:"QUEUE")& Identifica palavra chave tipo fila \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 15 & (?i:"FIRST")& Identifica palavra chave que representa \\&&  primeiro elemento da fila com as letras em \\&& caixa-alta e caixa-alta  \\
 \hline
 16 & (?i:"IF")& Identifica palavra chave condicional if \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 17 & (?i:"ELSE")& Identifica palavra chave condicional else \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 18 & (?i:"WHILE")& Identifica palavra chave do laço while \\&& com as letras em caixa-alta e caixa-alta \\
 \hline
 19 & (?i:"RETURN")& Identifica palavra chave return, de retorno \\&& de função, com as letras em caixa-alta e caixa-alta \\
 \hline
 20 & \{id\} & Reconhece um identificador cuja regra é: \\&& não é permitido conter símbolos além de \$, letras e \\&& dígitos e não é permitido começar a palara com dígito \\
 \hline
\end{tabular}
\end{center}
