...
\begin{itemize}
	...
	\item Expressões matemáticas são agora da forma \textit{identifier $\rightarrow$ number\_expression} ao invés de \textit{identifier $\rightarrow$ factor} para maior legibilidade;
