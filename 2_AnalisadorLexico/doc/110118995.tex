...
\begin{itemize}
	...
	\item A variável \textit{caractere} foi adicionada para representar o valor de um char, que só poderá ser ou uma letra ou um dígito;
...
% ==================================
% ============== MUDANÇAS NOVAS (SINTATICO): argument -> arguments (EM FUNCTION)
% ============== MUDANÇAS NOVAS (SINTATICO):
...
function
   \(\to\) {\color{red}argument} ( arguments ) \{ statements RETURN identifier ; \}
...
% ==================================
% ================================== 
REPENSAR \\ REPENSAR \\ REPENSAR \\ REPENSAR \\
% ==================================
% ==================================
% ==================================

matched_statements
   \(\to\) matched_statements matched_statement
   | \(\varepsilon\)
...
matched_statement
   \(\to\) IF ( compare\_expression ) matched_statement ELSE matched_statement
    | {\color{red}identifier ( identifiers ) ;}
    | {\color{red}identifier = identifier ( identifiers ) ;}
    | WHILE ( compare\_expression ) {\color{red}matched_statement}
...
open_statement
   \(\to\) IF ( compare\_expression ) statement
    | IF ( compare\_expression ) matched_statement ELSE open_statement
